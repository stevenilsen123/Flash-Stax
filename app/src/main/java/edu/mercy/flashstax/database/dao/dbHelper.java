...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_STACK_ID = "_id";
    ...
    public static final String SQL_CREATE_TABLE_STACKS = "CREATE TABLE " + TABLE_STACKS + "("
            + COL_STACK_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
    ...
    public static final String COL_CARD_ID = COL_STACK_ID;
    public static final String COL_CARD_STACK_NAME = "stackName";
    public static final String COL_CARD_NAME = "name";
    ...
    public static final String COL_CARD_STACK_ID = "stackId";
    ...
    public static final String SQL_CREATE_TABLE_CARDS = "CREATE TABLE " + TABLE_CARDS + "("
            ...
            + COL_CARD_STACK_ID + " INTEGER"
            + ");";

    // categories table
    public static final String TABLE_CATEGORIES = "categories";
    public static final String COL_CAT_ID = COL_STACK_ID;
